...
namespace SmartSchool.API.Data
{
    public class SmartContext : DbContext
    {
        ...
        // Quando estiver criando o banco de dados, esse OnModelCreating será executado
        protected override void OnModelCreating(ModelBuilder builder)
        {
            // Existe uma entidade AlunoDisciplina que ele tem algumas chaves, que no caso elas estão para AlunoID e DisciplinaID.
            // É assim que se faz para criar uma relação muitos para muitos, quando for N : N
